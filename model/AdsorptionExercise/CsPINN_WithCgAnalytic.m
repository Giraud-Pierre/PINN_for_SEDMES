...
figure('Name',sprintf('PINN for Cs with Cg Analytical, erreur = %f',err))
...
% savefig('../../results/AdsorptionExercise/MixedPINN/CsPINN_WithCgAnalytic.fig')
% save('../../results/AdsorptionExercise/MixedPINN/CsPINN_WithCgAnalytic.mat',"xplot","tplot","CsExact","Cspredict","net")